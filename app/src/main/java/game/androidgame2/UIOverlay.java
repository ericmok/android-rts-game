    ...
    public void processInput(GameCamera gameCamera,
        ...
        if (currentGesture == GameInput.GESTURE_ON_SINGLE_TAP_UP) {
            for (int i = 0; i < buttons.size(); i++) {
                ...
                temp.x = gameInput.touchPosition.x / gameCamera.scale + gameCamera.x;
                temp.y = gameInput.touchPosition.y / gameCamera.scale + gameCamera.y;
                ...
                if (bc.touchPoint.distanceTo(temp) < 4) {
